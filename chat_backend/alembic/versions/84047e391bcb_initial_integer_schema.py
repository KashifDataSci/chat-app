...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('encrypted_content', sa.Text(), nullable=False),  # For your AES encrypted payloads
        sa.Column('nonce', sa.String(), nullable=False),             # Critical companion for AES decryption
